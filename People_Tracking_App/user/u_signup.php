   ...
   $repeat_password = $_REQUEST["cpassword"];
    ...
    if(strlen($email)<=0){
     ...
     if(count($errorArray)<=0 || $valid == true){
        ...
        $insertUser = "INSERT INTO user(email,mobile,name,password,user_key,user_id,linked_id,linked_id_type,level)
        VALUES('$email','$mobile','$name','$password','$fetched_value','$user_id','$linkedid','$idtype',0)";
